...
<body class="market-page"><%@ include file="../includes/customer-navbar.jspf" %><main class="market-main"><div class="container">
    <section class="market-two-column">
        <article class="card"><div class="card__header"><h1 class="card__title">Complete booking details</h1></div><form class="card__body form" method="post" action="${pageContext.request.contextPath}/booking"><input type="hidden" name="serviceId" value="${service.serviceId}"><div class="form__grid"><label class="field"><span class="field__label">Date</span><input class="field__control" type="date" name="bookingDate" required></label><label class="field"><span class="field__label">Time</span><input class="field__control" type="time" name="bookingTime" required></label></div><label class="field"><span class="field__label">Address</span><textarea class="field__control" name="address" placeholder="Enter your service address"></textarea><span class="field__error">${addressError}</span></label><label class="field"><span class="field__label">Problem description</span><textarea class="field__control" name="notes" placeholder="Describe what needs to be fixed"></textarea></label><button class="btn btn--primary" type="submit">Confirm Booking</button></form></article>
